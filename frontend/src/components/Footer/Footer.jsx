    ...
    <footer className="bg-slate-950 text-slate-400 pt-16 pb-6 border-t border-slate-900">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div className="flex flex-col gap-4">
          <Link href="/" className="flex flex-col">
            <div className="flex items-center gap-1.5">
              <div className="bg-white text-slate-900 px-2 py-0.5 rounded flex items-center font-black tracking-tight">
                GRAB<span className="text-brand-amber">RENTAL</span>
              </div>
            </div>
            <span className="text-[10px] text-slate-400 font-semibold tracking-widest uppercase mt-0.5">
              Chauffeur & Intercity Cabs
            </span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li><Link href="/book/vehicles" className="hover:text-brand-amber transition-colors">Executive Sedans</Link></li>
            <li><Link href="/book/vehicles" className="hover:text-brand-amber transition-colors">Premium SUVs (Innova Crysta)</Link></li>
            <li><Link href="/vans" className="hover:text-brand-amber transition-colors">Tempo Travellers (9-26 Seater)</Link></li>
            <li><Link href="/buses" className="hover:text-brand-amber transition-colors">Luxury Volvo Coaches</Link></li>
            <li><Link href="/corporate" className="hover:text-brand-amber transition-colors">Corporate Fleet Solutions</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li><Link href="/corporate" className="hover:text-brand-amber transition-colors">Corporate Travel (B2B)</Link></li>
            <li><Link href="/support" className="hover:text-brand-amber transition-colors">Contact Us / Help Center</Link></li>
            <li><a href="tel:+918047109999" className="text-white font-medium hover:text-brand-amber transition-colors">Helpline: +91 80 4710 9999</a></li>
          </ul>
        </div>
      </div>
