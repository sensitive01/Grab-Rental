...
import com.example.rental.user.dto.UpdateUserStatusRequest;
...
public class AuthIntegrationTest {
    ...
    void testOtpSendAndVerifyAndUpdateProfile() throws Exception {
        ...
        com.example.rental.auth.dto.SendOtpRequest sendRequest = new com.example.rental.auth.dto.SendOtpRequest("9876543210");
        ...
        // Step 2: Verify OTP
        com.example.rental.auth.dto.VerifyOtpRequest verifyRequest = new com.example.rental.auth.dto.VerifyOtpRequest("9876543210", devOtp);
        ...
        com.example.rental.customer.dto.CustomerProfileUpdateRequest profileUpdate = com.example.rental.customer.dto.CustomerProfileUpdateRequest.builder()
