...
import com.example.rental.auth.dto.*;
import com.example.rental.common.exception.*;
...
public class AuthService {
    ...
    private final com.example.rental.customer.repository.CustomerProfileRepository customerProfileRepository;
    ...
    public LoginResponse verifyOtp(VerifyOtpRequest request) {
        ...
        User user = userRepository.findByPhone(phone).orElseGet(() -> {
            ...
            com.example.rental.customer.entity.CustomerProfile profile = com.example.rental.customer.entity.CustomerProfile.builder()
                    .user(saved)
                    .fullName("Customer")
                    .build();
